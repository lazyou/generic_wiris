...
class haxe_Http
{
    ...
    {
        if (!isset($this->onStatus)) {
            $this->onStatus = array(new _hx_lambda(array(&$this, &$url), "haxe_Http_0"), 'execute');
        }
        if (!isset($this->onError)) {
            $this->onError = array(new _hx_lambda(array(&$this, &$url), "haxe_Http_1"), 'execute');
        }
        if (!isset($this->onData)) {
            $this->onData = array(new _hx_lambda(array(&$this, &$url), "haxe_Http_2"), 'execute');
        }
    ...
    {
        return call_user_func_array($this->onStatus, array($status));
    }
    public $onStatus = null;
    public function onError($msg)
    {
        return call_user_func_array($this->onError, array($msg));
    }
    public $onError = null;
    public function onData($data)
    {
        return call_user_func_array($this->onData, array($data));
    }
    public $onData = null;
