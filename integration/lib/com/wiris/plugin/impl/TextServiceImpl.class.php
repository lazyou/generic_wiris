...
class com_wiris_plugin_impl_TextServiceImpl implements com_wiris_plugin_impl_HttpListener, com_wiris_plugin_api_TextService
{
    ...
    public static function hasCache($serviceName)
    {
    ...
    public static function hasStats($serviceName)
    {
    ...
    public static function getDigestExtension($serviceName, $provider)
    {
    ...
    {
        return 'com.wiris.plugin.impl.TextServiceImpl';
    }
}
