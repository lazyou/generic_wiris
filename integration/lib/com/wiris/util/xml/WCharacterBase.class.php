...
class com_wiris_util_xml_WCharacterBase
{
    ...
    public static $NEGATIVE_THIN_SPACE = 57344;
    public static $ROOT = 61696;
    public static $ROOT_VERTICAL = 61727;
    public static $ROOT_NO_TAIL = 61728;
    public static $ROOT_NO_TAIL_VERTICAL = 61759;
    public static $ROOT_LEFT_TAIL = 61760;
    public static $ROOT_VERTICAL_LINE = 61761;
    public static $ROUND_BRACKET_LEFT = 40;
    public static $ROUND_BRACKET_RIGHT = 41;
    public static $COMMA = 44;
    public static $FULL_STOP = 46;
    public static $SQUARE_BRACKET_LEFT = 91;
    public static $SQUARE_BRACKET_RIGHT = 93;
    public static $CIRCUMFLEX_ACCENT = 94;
    public static $LOW_LINE = 95;
    public static $CURLY_BRACKET_LEFT = 123;
    public static $VERTICAL_BAR = 124;
    public static $CURLY_BRACKET_RIGHT = 125;
    public static $TILDE = 126;
    public static $MACRON = 175;
    public static $COMBINING_LOW_LINE = 818;
    public static $MODIFIER_LETTER_CIRCUMFLEX_ACCENT = 710;
    public static $CARON = 711;
    public static $EN_QUAD = 8192;
    public static $EM_QUAD = 8193;
    public static $EN_SPACE = 8194;
    public static $EM_SPACE = 8195;
    public static $THICK_SPACE = 8196;
    public static $MID_SPACE = 8197;
    public static $SIX_PER_EM_SPACE = 8198;
    public static $FIGIRE_SPACE = 8199;
    public static $PUNCTUATION_SPACE = 8200;
    public static $THIN_SPACE = 8201;
    public static $HAIR_SPACE = 8202;
    public static $ZERO_WIDTH_SPACE = 8203;
    public static $ZERO_WIDTH_NON_JOINER = 8204;
    public static $ZERO_WIDTH_JOINER = 8205;
    public static $DOUBLE_VERTICAL_BAR = 8214;
    public static $DOUBLE_HORIZONTAL_BAR = 9552;
    public static $NARROW_NO_BREAK_SPACE = 8239;
    public static $MEDIUM_MATHEMATICAL_SPACE = 8287;
    public static $WORD_JOINER = 8288;
    public static $PLANCKOVER2PI = 8463;
    public static $LEFTWARDS_ARROW = 8592;
    public static $UPWARDS_ARROW = 8593;
    public static $RIGHTWARDS_ARROW = 8594;
    public static $DOWNWARDS_ARROW = 8595;
    public static $LEFTRIGHT_ARROW = 8596;
    public static $UP_DOWN_ARROW = 8597;
    public static $LEFTWARDS_ARROW_FROM_BAR = 8612;
    public static $RIGHTWARDS_ARROW_FROM_BAR = 8614;
    public static $LEFTWARDS_ARROW_WITH_HOOK = 8617;
    public static $RIGHTWARDS_ARROW_WITH_HOOK = 8618;
    public static $LEFTWARDS_HARPOON_WITH_BARB_UPWARDS = 8636;
    public static $RIGHTWARDS_HARPOON_WITH_BARB_UPWARDS = 8640;
    public static $LEFTWARDS_DOUBLE_ARROW = 8656;
    public static $RIGHTWARDS_DOUBLE_ARROW = 8658;
    public static $LEFT_RIGHT_DOUBLE_ARROW = 8660;
    public static $LEFTWARDS_ARROW_OVER_RIGHTWARDS_ARROW = 8646;
    public static $RIGHTWARDS_ARROW_OVER_LEFTWARDS_ARROW = 8644;
    public static $LEFTWARDS_HARPOON_OVER_RIGHTWARDS_HARPOON = 8651;
    public static $RIGHTWARDS_HARPOON_OVER_LEFTWARDS_HARPOON = 8652;
    public static $RIGHTWARDS_ARROW_ABOVE_SHORT_LEFTWARDS_ARROW = 10562;
    public static $SHORT_RIGHTWARDS_ARROW_ABOVE_LEFTWARDS_ARROW = 10564;
    public static $LONG_RIGHTWARDS_ARROW = 10230;
    public static $LONG_LEFTWARDS_ARROW = 10229;
    public static $LONG_LEFT_RIGHT_ARROW = 10231;
    public static $LONG_LEFTWARDS_DOUBLE_ARROW = 10232;
    public static $LONG_RIGHTWARDS_DOUBLE_ARROW = 10233;
    public static $LONG_LEFT_RIGHT_DOUBLE_ARROW = 10234;
    public static $TILDE_OPERATOR = 8764;
    public static $LEFT_CEILING = 8968;
    public static $RIGHT_CEILING = 8969;
    public static $LEFT_FLOOR = 8970;
    public static $RIGHT_FLOOR = 8971;
    public static $TOP_PARENTHESIS = 9180;
    public static $BOTTOM_PARENTHESIS = 9181;
    public static $TOP_SQUARE_BRACKET = 9140;
    public static $BOTTOM_SQUARE_BRACKET = 9141;
    public static $TOP_CURLY_BRACKET = 9182;
    public static $BOTTOM_CURLY_BRACKET = 9183;
    public static $MATHEMATICAL_LEFT_ANGLE_BRACKET = 10216;
    public static $MATHEMATICAL_RIGHT_ANGLE_BRACKET = 10217;
    public static $DOUBLE_STRUCK_ITALIC_CAPITAL_D = 8517;
    public static $DOUBLE_STRUCK_ITALIC_SMALL_D = 8518;
    public static $DOUBLE_STRUCK_ITALIC_SMALL_E = 8519;
    public static $DOUBLE_STRUCK_ITALIC_SMALL_I = 8520;
    public static $EPSILON = 949;
    public static $VAREPSILON = 1013;
    public static $DIGIT_ZERO = 48;
    public static $DIGIT_NINE = 57;
    public static $LATIN_CAPITAL_LETTER_A = 65;
    public static $LATIN_CAPITAL_LETTER_Z = 90;
    public static $LATIN_SMALL_LETTER_A = 97;
    public static $LATIN_SMALL_LETTER_Z = 122;
    public static $MATHEMATICAL_SCRIPT_CAPITAL_A = 119964;
    public static $MATHEMATICAL_SCRIPT_SMALL_A = 119990;
    public static $MATHEMATICAL_FRAKTUR_CAPITAL_A = 120068;
    public static $MATHEMATICAL_FRAKTUR_SMALL_A = 120094;
    public static $MATHEMATICAL_DOUBLE_STRUCK_CAPITAL_A = 120120;
    public static $MATHEMATICAL_DOUBLE_STRUCK_SMALL_A = 120146;
    public static $MATHEMATICAL_DOUBLE_STRUCK_DIGIT_ZERO = 120792;
    ...
    public static $binaryOps;
    public static $relations;
    public static $largeOps;
    public static $veryLargeOps;
    public static $tallLetters;
    public static $longLetters;
    public static $negations;
    public static $mirrorDictionary;
    public static $subSuperScriptDictionary;
    public static $accentsDictionary = null;
    public static function initAccentsDictionary()
    {
    ...
    public static function getUnicodeCategoryList($category)
    {
    ...
    public static function getUnicodesRangedStringList($unicodesRangedList)
    {
    ...
    public static function hexStringToUnicode($unicode)
    {
        return Std::parseInt("0x" . $unicode);
    }
    public static $invisible;
    public static function getMirror($str)
    {
        $mirroredStr = "";
        $i = 0;
        while ($i < strlen($str)) {
    ...
    public static function isStretchyLTR($c)
    {
        $i = 0;
    ...
    public static function getNegated($c)
    {
        $i = 0;
    ...
    public static function getNotNegated($c)
    {
        $i = 1;
        while ($i < com_wiris_util_xml_WCharacterBase::$negations->length) {
            if (com_wiris_util_xml_WCharacterBase::$negations[$i] === $c) {
    ...
    public static function isCombining($s)
    {
    ...
    public static function isCombiningCharacter($c)
    {
    ...
    public static function isUnicodeMathvariant($c)
    {
    ...
    public static function isArabianString($s)
    {
        $i = strlen($s) - 1;
        while ($i >= 0) {
    ...
    public static function isArabian($c)
    {
    ...
    public static function isHebrew($c)
    {
        if ($c >= 1424 && $c <= 1535) {
            return true;
        }
    ...
    public static function isChinese($c)
    {
        if ($c >= 13312 && $c <= 40959) {
            return true;
        }
    ...
    public static function isKorean($c)
    {
        if ($c >= 12593 && $c <= 52044) {
            return true;
        }
    ...
    public static function isGreek($c)
    {
        if ($c >= 945 && $c <= 969) {
            return true;
        } else {
    ...
    public static function isDevanagari($c)
    {
        if ($c >= 2304 && $c < 2431) {
            return true;
        }
    ...
    public static function isGujarati($c)
    {
    ...
    public static function isThai($c)
    {
        if (3585 <= $c && $c < 3676) {
            return true;
        }
    ...
    public static function isDevanagariString($s)
    {
        $i = strlen($s) - 1;
        while ($i >= 0) {
    ...
    public static function isRTL($c)
    {
    ...
    public static function isTallLetter($c)
    {
    ...
    public static function isLongLetter($c)
    {
        if (97 <= $c && $c <= 122 || 945 <= $c && $c <= 969) {
    ...
    public static function isLTRNumber($text)
    {
        $i = 0;
    ...
    public static function greek2Latin($g)
    {
        $index = -1;
        if ($g < 100) {
    ...
    public static function isTallAccent($c)
    {
        $i = 0;
    ...
    public static function isDisplayedWithStix($c)
    {
        if ($c >= 592 && $c <= 687) {
            return true;
        }
    ...
    public static function latinToDoublestruck($codepoint)
    {
        if ($codepoint === 67) {
            return 8450;
        } else {
    ...
    public static function latinToScript($codepoint)
    {
        if ($codepoint === 66) {
            return 8492;
        } else {
    ...
    public static function latinToFraktur($codepoint)
    {
        if ($codepoint === 67) {
            return 8493;
        } else {
    ...
    public static function stripAccent($c)
    {
    ...
    {
        return 'com.wiris.util.xml.WCharacterBase';
    }
}
