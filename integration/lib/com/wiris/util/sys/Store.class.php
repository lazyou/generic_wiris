...
class com_wiris_util_sys_Store
{
    ...
    public static function newStore($folder)
    {
        $s = new com_wiris_util_sys_Store();
        $s->file = $folder;
        return $s;
    }
    public static function newStoreWithParent($store, $str)
    {
    ...
    public static function deleteDirectory($folder, $included)
    {
    ...
    {
        return 'com.wiris.util.sys.Store';
    }
}
