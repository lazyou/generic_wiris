...
class com_wiris_system_Storage
{
    ...
    public static function newResourceStorage($name)
    {
    ...
    public static function newStorage($name)
    {
        return new com_wiris_system_Storage($name);
    }
    public static function newStorageWithParent($parent, $name)
    {
    ...
    public static function setResourcesDir()
    {
    ...
    public static function isSystemFile($file)
    {
    ...
    public static function setDirectorySeparator()
    {
        $sep = null;
