...
class com_wiris_system_TypeTools
{
    ...
    public static function isFloating($str)
    {
    ...
    public static function isArray($o)
    {
        return Std::is($o, _hx_qtype("Array"));
    }
    public static function isHash($o)
    {
        return Std::is($o, _hx_qtype("Hash"));
    }
    public static function string2ByteData_iso8859_1($str)
    {
        return haxe_io_Bytes::ofString($str);
    }
    public function __toString()
    {
        return 'com.wiris.system.TypeTools';
    }
}
